...
void GUI_initTheme()
{
    ...
    lv_theme_t *Theme = lv_theme_default_init(Display, lv_palette_main(LV_PALETTE_BLUE), lv_palette_main(LV_PALETTE_RED), false, lv_font_get_default());
