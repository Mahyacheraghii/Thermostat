#include "../assets/images/dashboard.c"
#include "../assets/images/power.c"
#include "../assets/images/fan.c"
#include "../assets/images/wifi.c"
#include "../assets/images/sun.c"
#include "../assets/images/pump.c"
#include "../../GUI.h"

lv_obj_t *GUI_Image__screen__sunImg;
...
void GUI_initScreen__screen()
{
    ...
    lv_obj_set_size(GUI_Image__screen__dashboardImg, 20, 20);
    ...
    lv_obj_set_size(GUI_Image__screen__wifiImage, 20, 20);
    ...
    lv_obj_set_size(GUI_Image__screen__moistureImg, 9, 9);
    ...
    lv_obj_set_size(GUI_Image__screen__moodImg, 30, 15);
    ...
    lv_obj_set_size(GUI_Image__screen__fanImg, 30, 15);
    ...
    lv_obj_set_size(GUI_Image__screen__pumpImg, 30, 15);
    ...
    lv_obj_set_size(GUI_Image__screen__powerImg, 30, 15);
    lv_obj_add_event_cb(GUI_Image__screen__powerImg, GUI_event__Image__screen__powerImg__Clicked, LV_EVENT_CLICKED, NULL);

    GUI_Image__screen__sunImg = lv_image_create(GUI_Container__screen__controlleersContainer);
    lv_obj_add_flag(GUI_Image__screen__sunImg, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_remove_flag(GUI_Image__screen__sunImg, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_align(GUI_Image__screen__sunImg, LV_ALIGN_CENTER);
    lv_obj_set_size(GUI_Image__screen__sunImg, 30, 15);
...
void GUI_initScreenStyles__screen()
{
    ...
    lv_image_set_src(GUI_Image__screen__sunImg, &sun);
}
