...
#ifndef LV_ATTRIBUTE_IMAGE_FAN_OFF
#define LV_ATTRIBUTE_IMAGE_FAN_OFF
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMAGE_FAN_OFF uint8_t fan_off_map[] = {
