...
#ifndef LV_ATTRIBUTE_IMAGE_WIFI_MIDUM
#define LV_ATTRIBUTE_IMAGE_WIFI_MIDUM
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMAGE_WIFI_MIDUM uint8_t wifi_midum_map[] = {
...
const lv_image_dsc_t wifi_midum = {
